    ...
    <div className="bg-muted w-full h-dvh flex justify-center items-center ">
      <div className="bg-card w-[80%] max-w-[400px] h-[auto] p-8 flex flex-col justify-center items-center gap-4 rounded-[8px] shadow-md">
        ...
        <div className="w-full flex justify-start items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">JOSCM <span className="text-[#2f6a7a] ">Tithes App</span></h1>
        ...
        <div className="bg-[]">
            <p className="text-[9px] text-muted-foreground"> &copy; {new Date().getFullYear()} - Design & Built by ianDev</p>
        </div>
      </div>
    </div>
  );
